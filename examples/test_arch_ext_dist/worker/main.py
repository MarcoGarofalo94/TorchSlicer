"""
Worker for the architecture extension distributed smoke test.

Identical to the generic centralized worker, but also imports
examples/test_arch_ext_dist/models.py so that torch.load() can
deserialize the synthetic DeepSeek-V2 MoE classes.
"""
...
# Make the synthetic model classes importable by torch.load()
sys.path.insert(0, "/workspace/examples/test_arch_ext_dist")
