...
from proto_common.coordinator import coordinator_service_pb2 as proto__common_dot_coordinator_dot_coordinator__service__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in proto_common/coordinator/coordinator_service_pb2_grpc.py depends on'
